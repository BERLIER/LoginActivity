...
import com.sebastien.screen.ClientModel;
...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private ArrayList<ClientModel> cartList = new ArrayList<ClientModel>();
	Context c;
	...
	public void addProduct(ClientModel productitem) {
	...
	public void updateProduct(ClientModel productList) {
		SQLiteDatabase db = this.getWritableDatabase();
		ContentValues contentValues = new ContentValues();
	...
	public ArrayList<ClientModel> getProudcts() {
